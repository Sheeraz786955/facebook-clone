  ...
  return (
    <main>
      ...
      <div className="right flex flex-col bg-white p-8 rounded-xl w-1/3">
        ...
        <hr className='my-2'/>
        <Button2/>
        <span className='absolute bottom-28  text-sm px-4' ><span className='font-bold hover:underline cursor-pointer'>Create a Page</span> for a celebrity, brand or business.</span>
      </div>
      </div>
    </main>
  )
